...
const Homepage = () => {
  return (
    <>
    <div className="w-full h-full bg-black overflow-hidden pointer-events-none absolute inset-0 -z-10">
    ...
    <main className="isolate relative p-4 md:p-8 size-full overflow-y-auto scrollbar-styled text-white">
